StateManagement Techniques is used to store the data for later point of use until the users session ends.

StateManagement Techniques are
     
1)Client side StateManagement Techniques:
...
2) Server side StateManagement Techniques:
